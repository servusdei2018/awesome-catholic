# Génial Catholique [![Awesome](https://awesome.re/badge-flat.svg)](https://awesome.re)
...
- [liturgical-calendar-mcp](https://github.com/CatholicOS/liturgical-calendar-mcp) - Un serveur MCP (Model Context Protocol) qui permettra aux agents d'IA d'interagir avec l'API du calendrier liturgique.
...
- [Little Office](https://apps.apple.com/us/app/the-little-office/id6746760526) - L'application « Le Petit Office de la Vierge Marie » pour iOS, dotée d'une interface élégante et intuitive. Version Android bientôt disponible !
- [gregorio](https://github.com/gregorio-project/gregorio) - Une application logicielle permettant de graver des partitions de chant grégorien sur un ordinateur.
...
- [avemarie](https://github.com/oodler577/p5-Webservice-Rosary-API) - Client en ligne de commande pour le Rosaire quotidien, distribué dans le cadre du module Perl [Webservice::Rosary::API](https://metacpan.org/pod/Webservice::Rosary::API).
...
- [graduale-romanum-1908](https://github.com/ahinkley/graduale-romanum-1908) - L'Édition du Vatican 1908 Retypeset romain progressif dans Gregorio 4.
...
- [ecclesia-atlas](https://github.com/gustavofsousa/ecclesia-atlas) - Jeu de données ouvert, versionné et avec provenance par champ de la structure ecclésiastique de l'Église catholique au Brésil (diocèses, provinces, régionaux de la CNBB).
...
- [Confessa-te](https://apps.apple.com/pt/app/confessa-te/id6757074474) - Application iOS multilingue pour aider les catholiques à se préparer au sacrement de la Confession.
- [Missas Portugal](https://apps.apple.com/pt/app/missas-portugal/id6754783103) - Application iOS gratuite pour les horaires des messes catholiques au Portugal.
...
- [GregoSearch](https://busca.liturgiacantada.com.br) - Une interface de recherche moderne et puissante pour GregoBase, l'une des plus grandes bases de données de partitions de chant grégorien.
...
- [Confessate](https://confessate.pt) - Une ressource pour aider les fidèles à se préparer et à trouver le sacrement de la Confession.
- [Documentos Católicos Fundamentais](https://documentos-catolicos-fundamentais.pt) - Une collection de documents catholiques fondamentaux (portugais).
- [HorariosMissas](https://horariosmissas.pt) - Un annuaire gratuit et sans publicité des horaires de messe pour les paroisses du Portugal et de ses îles.
- [1954 Ordo](https://ordo.restorethe54.com) - Un ordo contenant les fêtes quotidiennes du calendrier de 1954, avec des flux iCal. Inclut également un flux iCal des jours pénitentiels.
- [Little Office of the Blessed Virgin Mary](https://lobvm.com/) - Une application web présentant le LOBVM dans un format adaptatif et compatible avec les appareils mobiles.
...
- [Awesome Catholic (CatholicOS)](https://github.com/CatholicOS/awesome-catholic) - Une liste organisée de projets technologiques catholiques.
