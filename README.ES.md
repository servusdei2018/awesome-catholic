# Impresionante Católico [![Awesome](https://awesome.re/badge-flat.svg)](https://awesome.re)
...
- [liturgical-calendar-mcp](https://github.com/CatholicOS/liturgical-calendar-mcp) - Un servidor MCP (Model Context Protocol) que permitirá a los agentes de IA interactuar con la API del Calendario Litúrgico.
...
- [lumen-impulse](https://github.com/michaelporwol/lumen-impulse) - API para reflexiones diarias del Evangelio católico en alemán, inglés y polaco, generadas mediante GitHub Actions y Magisterium AI.
- [The-Collection-of-Catholic-Prayers-API](https://github.com/erickouassi/The-Collection-of-Catholic-Prayers-Api) - API REST integral que proporciona acceso a una amplia colección de oraciones católicas tradicionales, devociones y recursos litúrgicos.
...
- [Little Office](https://apps.apple.com/us/app/the-little-office/id6746760526) - La Pequeña Oficina de la Santísima Virgen María para iOS, con una interfaz elegante y fácil de usar. ¡Próximamente para Android!
- [gregorio](https://github.com/gregorio-project/gregorio) - Una aplicación de software para grabar partituras del canto gregoriano en una computadora.
...
- [GregoSearch](https://busca.liturgiacantada.com.br) - Una interfaz de búsqueda moderna y potente para GregoBase, una de las bases de datos más grandes de partituras de canto gregoriano.
...
- [Index Librorum Prohibitorum](https://github.com/leozamboni/index-librorum-prohibitorum) - Sitio para consultar el Index Librorum Prohibitorum, libros que un católico debe leer con precaución. Demo en https://leozamboni.github.io/index-librorum-prohibitorum/.
...
- [1954 Ordo](https://ordo.restorethe54.com) - Un ordo con las fiestas diarias del calendario de 1954, incluyendo feeds iCal. También incluye un feed iCal de días penitenciales.
- [Little Office of the Blessed Virgin Mary](https://lobvm.com/) - Una aplicación web con una presentación adaptable y compatible con dispositivos móviles del LOBVM.
...
- [Awesome Catholic (CatholicOS)](https://github.com/CatholicOS/awesome-catholic) - Una lista seleccionada de proyectos tecnológicos católicos.
