# Awesome Catholic [![Awesome](https://awesome.re/badge-flat.svg)](https://awesome.re)
...
- [The-Collection-of-Catholic-Prayers-API](https://github.com/erickouassi/The-Collection-of-Catholic-Prayers-Api) - Comprehensive REST API providing access to a wide collection of traditional Catholic prayers, devotions, and liturgical resources.
...
- [gregorio](https://github.com/gregorio-project/gregorio) - Software application for engraving Gregorian Chant scores on a computer.
...
- [Oficjum](https://github.com/anna-wro/rkk) - A Progressive Web App that provides daily liturgical texts for the Liturgy of the Hours in Polish. Demo at https://oficjum.starokatolicy.eu/.
...
- [1954 Ordo](https://ordo.restorethe54.com) - An ordo containing the daily feasts of the 1954 calendar, including ical feeds. Also includes an ical feed of penitential days.
- [Little Office of the Blessed Virgin Mary](https://lobvm.com/) - A webapp containing mobile-friendly responsive presentation of the LOBVM.
...
- [Awesome Catholic (CatholicOS)](https://github.com/CatholicOS/awesome-catholic) - A curated list of Catholic technology projects.
